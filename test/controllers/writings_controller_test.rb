...
class WritingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create writing" do
    assert_difference('Writing.count') do
      post writings_url, params: { writing: { link: @writing.link, title: @writing.title, year: @writing.year } }
    end
  ...
  test "should update writing" do
    patch writing_url(@writing), params: { writing: { link: @writing.link, title: @writing.title, year: @writing.year } }
