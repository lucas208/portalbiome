class IndividualsController < ApplicationController
  ...
  def index
    @individuals = Individual.all.order(:name)
  end
  ...
  private
    ...
    def individual_params
      params.require(:individual).permit(:name, :linklattes,:linksigaa, :linkscholar,:linkpubmed, :photo, :email, :individualcategory_id)
    end
end
